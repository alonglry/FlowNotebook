...
export const ExportModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-6 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl h-[85vh] bg-[#0e1422] border border-slate-700/80 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 bg-[#141b2d] border-b border-slate-800">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-white">Export Standalone Python Script</h2>
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-1.5 bg-sky-600 hover:bg-sky-500 text-white text-xs font-medium rounded-lg transition-colors shadow-sm"
            >
        ...
        {/* Modal Footer */}
        <div className="flex items-center justify-between px-6 py-3 bg-[#111827] border-t border-slate-800 text-xs text-slate-400">
          <span>Run via CLI: <code className="text-sky-300 font-mono bg-slate-900 px-2 py-0.5 rounded">python dag_pipeline_standalone.py</code></span>
          <button
            onClick={() => setIsExportModalOpen(false)}
